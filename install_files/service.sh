...
init_config() {
  if [ -e "$CONFIG_PATH" ]; then
    ...
    set_config BYPASS_SOURCE_PORT_LIST "0-1023"
    ...
    set_config INIT_CHECKS_ENABLED 1
  ...
  [ -z "$BYPASS_SOURCE_PORT_LIST" ] && BYPASS_SOURCE_PORT_LIST="0-1023"
  ...
  [ -z "$INIT_CHECKS_ENABLED" ] && INIT_CHECKS_ENABLED=1
