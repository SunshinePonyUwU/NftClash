...
init_config() {
	if [ -e "$CONFIG_PATH" ]; then
		...
		set_config BYPASS_SOURCE_PORT_LIST "0-1024,8000-8443,9000-9443,19132-19133,25565"
	...
	[ -z "$BYPASS_SOURCE_PORT_LIST" ] && BYPASS_SOURCE_PORT_LIST="0-1024,8000-8443,9000-9443,19132-19133,25565"
