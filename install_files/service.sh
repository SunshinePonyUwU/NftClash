...
init_config() {
	if [ -e "$CONFIG_PATH" ]; then
		...
		set_config BYPASS_SOURCE_PORT_LIST "0-1024,8000-8880,19132-19133,25565"
	...
	[ -z "$BYPASS_SOURCE_PORT_LIST" ] && BYPASS_SOURCE_PORT_LIST="0-1024,8000-8880,9000-9990,19132-19133,25565"
